...
5. separate Claude Code, Cursor, and GitHub Copilot adapters only after their exact contracts have independent fixtures and failure tests. [ADR 0015](0015-claude-code-hook-edge.md) accepts the Claude Code research proposal but no adapter or lifecycle yet.

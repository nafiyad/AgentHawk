...
describe("qualifyCommand", () => {
  ...
  it.each([
    ...
    ["$(printf npm) add lodash", "unsupported_package_manager"],
    ["/usr/bin/n?m add lodash", "shell_composition"],
    ["n*m add lodash", "shell_composition"],
    ["echo ok; npm add lodash", "unsupported_package_manager"],
    ["echo ok; n\\pm add lodash", "unsupported_package_manager"],
    ["echo $(npm add lodash)", "unsupported_package_manager"],
    ["echo `npm add lodash`", "unsupported_package_manager"],
    ["! npm add lodash", "unsupported_package_manager"],
    ...
    ["echo npm", "unsupported_package_manager"],
    ["git commit -m npm", "unsupported_package_manager"],
    ["printf yarn", "unsupported_package_manager"],
    ["setarch x86_64 npm add lodash", "unsupported_package_manager"],
    ["linux64 npm add lodash", "unsupported_package_manager"],
    ["ltrace npm add lodash", "unsupported_package_manager"],
    ["valgrind npm add lodash", "unsupported_package_manager"],
    ["gdb -batch -ex run --args npm add lodash", "unsupported_package_manager"],
    ["firejail npm add lodash", "unsupported_package_manager"],
    ["flatpak-spawn --host npm add lodash", "unsupported_package_manager"],
    ["chronic npm add lodash", "unsupported_package_manager"],
    ["numactl npm add lodash", "unsupported_package_manager"],
    ["srun npm add lodash", "unsupported_package_manager"],
    ...
    ["echo $(echo $(npm add lodash))", "unsupported_package_manager"],
